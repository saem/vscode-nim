...
import {
    ...
    // nimSuggestExec
    initNimSuggest, closeAllNimSuggestProcesses,

    // nimUtils
    getDirtyFile, outputLine,
...
export function activate(ctx: vscode.ExtensionContext): void {
    ...
    if (vscode.workspace.getConfiguration('nim').get('enableNimsuggest') as boolean) {
        ...
        ctx.subscriptions.push(vscode.languages.registerReferenceProvider(NIM_MODE, nimReferenceProvider));
        ...
        ctx.subscriptions.push(vscode.languages.registerDocumentFormattingEditProvider(NIM_MODE, nimFormattingProvider));
    }
